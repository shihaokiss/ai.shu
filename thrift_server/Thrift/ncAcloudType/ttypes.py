...
class ncAcloudLoginInfoRq(object):
  ...
  def __init__(self, serverIP=None, username=None, password=None,):
...
class ncGetAcloudLoginInfo(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'loginInfo', (ncAcloudLoginInfoRq, ncAcloudLoginInfoRq.thrift_spec), None, ), # 1
...
class ncAcloudHostInfoSet(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'acloudHostInfos', (TType.STRUCT,(ncAcloudHostInfo, ncAcloudHostInfo.thrift_spec)), None, ), # 1
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.acloudHostInfos)
    return value
...
class ncAcloudNodeObjSet(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'acloudNodeObjs', (TType.STRUCT,(ncAcloudNodeObj, ncAcloudNodeObj.thrift_spec)), None, ), # 1
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.acloudNodeObjs)
    return value
...
class ncAcloudStoragePoolSet(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'dsPools', (TType.STRUCT,(ncAcloudStoragePool, ncAcloudStoragePool.thrift_spec)), None, ), # 1
  )
...
class ncAcloudVSwitchSet(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'vSwitchs', (TType.STRUCT,(ncAcloudVSwitch, ncAcloudVSwitch.thrift_spec)), None, ), # 1
  )
...
class ncAcloudDataSourceSet(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'acloudDataSources', (TType.STRUCT,(ncAcloudDataSource, ncAcloudDataSource.thrift_spec)), None, ), # 1
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.acloudDataSources)
    return value
...
class ncAcloudDataSourceReq(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'loginInfo', (ncAcloudLoginInfoRq, ncAcloudLoginInfoRq.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'acloudDataSourceList', (ncAcloudDataSourceSet, ncAcloudDataSourceSet.thrift_spec), None, ), # 2
    (3, TType.LIST, 'bindIPSet', (TType.STRING,None), None, ), # 3
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.loginInfo)
    value = (value * 31) ^ hash(self.acloudDataSourceList)
...
class ncAcloudJobClientRequest(object):
  ...
  thrift_spec = (
    ...
    (3, TType.STRUCT, 'acloudDataSourceList', (ncAcloudDataSourceSet, ncAcloudDataSourceSet.thrift_spec), None, ), # 3
  )
...
class ncAcloudRecoverDataSourceReq(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'loginInfo', (ncAcloudLoginInfoRq, ncAcloudLoginInfoRq.thrift_spec), None, ), # 1
    (2, TType.LIST, 'dsPools', (TType.STRUCT,(ncAcloudStoragePool, ncAcloudStoragePool.thrift_spec)), None, ), # 2
    (3, TType.LIST, 'bindIPSet', (TType.STRING,None), None, ), # 3
  )
...
class ncAcloudRecoverJobClientRequest(object):
  ...
  thrift_spec = (
    ...
    (1, TType.STRING, 'clientIp', None, None, ), # 1
    (2, TType.STRING, 'vplatformId', None, None, ), # 2
    (3, TType.LIST, 'dsPools', (TType.STRUCT,(ncAcloudStoragePool, ncAcloudStoragePool.thrift_spec)), None, ), # 3
  )
...
class ncAcloudStorageHosts(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'storage', (ncAcloudStoragePool, ncAcloudStoragePool.thrift_spec), None, ), # 1
    (2, TType.LIST, 'acloudHostInfos', (TType.STRUCT,(ncAcloudHostInfo, ncAcloudHostInfo.thrift_spec)), None, ), # 2
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.storage)
    value = (value * 31) ^ hash(self.acloudHostInfos)
    return value
...
class ncAcloudStorageHostSet(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'acloudStorageHosts', (TType.STRUCT,(ncAcloudStorageHosts, ncAcloudStorageHosts.thrift_spec)), None, ), # 1
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.acloudStorageHosts)
    return value

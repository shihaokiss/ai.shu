...
class ncFileSystemInfo(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'mount_path', None, None, ), # 1
    (2, TType.STRING, 'dev_path', None, None, ), # 2
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.mount_path = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.mount_path is not None:
      ...
      oprot.writeString(self.mount_path.encode('utf-8'))
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.mount_path)
...
class ncApplicationVolume(object):
  ...
  thrift_spec = (
    ...
    (12, TType.STRING, 'application_volume_group_guid', None, None, ), # 12
    (13, TType.STRING, 'node_id', None, None, ), # 13
    (14, TType.STRING, 'node_ip', None, None, ), # 14
    (15, TType.STRING, 'raid_name', None, None, ), # 15
    (16, TType.STRING, 'pool_id', None, None, ), # 16
    (17, TType.STRUCT, 'file_system', (ncFileSystemInfo, ncFileSystemInfo.thrift_spec), None, ), # 17
    (18, TType.STRING, 'desc', None, None, ), # 18
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.application_volume_group_guid = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 13:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.application_volume_group_guid is not None:
      ...
      oprot.writeString(self.application_volume_group_guid.encode('utf-8'))
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.volume_status)
    value = (value * 31) ^ hash(self.volume_size)
    value = (value * 31) ^ hash(self.used_size)
    value = (value * 31) ^ hash(self.free_size)
    value = (value * 31) ^ hash(self.quota_size)
    value = (value * 31) ^ hash(self.storage_type)
    value = (value * 31) ^ hash(self.dispatch)
    value = (value * 31) ^ hash(self.application_volume_id)
    value = (value * 31) ^ hash(self.application_volume_group_guid)
    ...
    value = (value * 31) ^ hash(self.file_system)
...
class ncGetApplicationVolumesResponse(object):
  ...
  thrift_spec = (
    ...
    (4, TType.LIST, 'volumes', (TType.STRUCT,(ncApplicationVolume, ncApplicationVolume.thrift_spec)), None, ), # 4
  )
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.volumes)
    return value
...
class ncCreateApplicationVolumeRequest(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'application_volume', (ncApplicationVolume, ncApplicationVolume.thrift_spec), None, ), # 1
    (2, TType.I64, 'raid_usable', None, None, ), # 2
    (3, TType.I64, 'path_size', None, None, ), # 3
    (4, TType.STRING, 'desc', None, None, ), # 4
    (5, TType.STRING, 'task_id', None, None, ), # 5
    (6, TType.STRING, 'user_name', None, None, ), # 6
    (7, TType.STRING, 'login_ip', None, None, ), # 7
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.login_ip = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.login_ip is not None:
      ...
      oprot.writeString(self.login_ip.encode('utf-8'))
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.application_volume)
    value = (value * 31) ^ hash(self.raid_usable)
    value = (value * 31) ^ hash(self.path_size)
    value = (value * 31) ^ hash(self.desc)
    value = (value * 31) ^ hash(self.task_id)
    value = (value * 31) ^ hash(self.user_name)
    value = (value * 31) ^ hash(self.login_ip)
    return value
...
class ncDeleteApplicationVolumeRequest(object):
  ...
  thrift_spec = (
    ...
    (4, TType.STRING, 'login_ip', None, None, ), # 4
  )
...
class ncEditApplicationVolumeRequest(object):
  ...
  thrift_spec = (
    ...
    (6, TType.STRING, 'login_ip', None, None, ), # 6
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.application_volume)
    value = (value * 31) ^ hash(self.edit_size)
    value = (value * 31) ^ hash(self.desc)
    value = (value * 31) ^ hash(self.task_id)
    value = (value * 31) ^ hash(self.user_name)
    value = (value * 31) ^ hash(self.login_ip)
...
class ncVolume(object):
  ...
  thrift_spec = (
    ...
    (6, TType.I64, 'used_size', None, None, ), # 6
    (7, TType.STRING, 'pool_id', None, None, ), # 7
    (8, TType.I32, 'status', None, None, ), # 8
    (9, TType.I32, 'storage_type', None, None, ), # 9
    (10, TType.STRING, 'father_name', None, None, ), # 10
    (11, TType.STRING, 'third_party_pool_id', None, None, ), # 11
  )

  def __init__(self, id=None, name=None, wwn=None, type=None, total_size=None, used_size=None, pool_id=None, status=None, storage_type=None, father_name=None, third_party_pool_id=None,):
    self.id = id
    self.name = name
    self.wwn = wwn
    self.type = type
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.father_name = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 11:
        if ftype == TType.STRING:
          self.third_party_pool_id = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.father_name is not None:
      ...
      oprot.writeString(self.father_name.encode('utf-8'))
      oprot.writeFieldEnd()
    if self.third_party_pool_id is not None:
      oprot.writeFieldBegin('third_party_pool_id', TType.STRING, 11)
      oprot.writeString(self.third_party_pool_id.encode('utf-8'))
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.storage_type)
    value = (value * 31) ^ hash(self.father_name)
    value = (value * 31) ^ hash(self.third_party_pool_id)
    return value
...
class ncCreateVolumeRequest(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'volume', (ncVolume, ncVolume.thrift_spec), None, ), # 1
  )
...
class ncDeleteVolumeRequest(object):
  ...
  thrift_spec = (
    ...
    (2, TType.LIST, 'volume_names', (TType.STRING,None), None, ), # 2
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.pool_id)
    value = (value * 31) ^ hash(self.volume_names)
    return value
...
class ncTask(object):
  ...
  thrift_spec = (
    ...
    (3, TType.I32, 'type', None, None, ), # 3
    (4, TType.STRING, 'error_info', None, None, ), # 4
  )
...
class ncDisks(object):
  ...
  thrift_spec = (
    ...
    (13, TType.STRING, 'enclosureDeviceId', None, None, ), # 13
    (14, TType.STRING, 'coercedSize', None, None, ), # 14
    (15, TType.STRING, 'firmwareState', None, None, ), # 15
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.enclosureDeviceId = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 14:
        if ftype == TType.STRING:
          self.coercedSize = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 15:
        if ftype == TType.STRING:
          self.firmwareState = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.enclosureDeviceId)
    value = (value * 31) ^ hash(self.coercedSize)
    value = (value * 31) ^ hash(self.firmwareState)
    return value
...
class ncThirdPartyStorage(object):
  ...
  thrift_spec = (
    ...
    (5, TType.STRING, 'ip', None, None, ), # 5
    (6, TType.I32, 'port', None, None, ), # 6
    (7, TType.STRING, 'user_name', None, None, ), # 7
...
class ncPool(object):
  ...
  thrift_spec = (
    ...
    (14, TType.STRING, 'storage_media_type', None, None, ), # 14
    (15, TType.STRING, 'cache_media_type', None, None, ), # 15
    (16, TType.STRING, 'pool_id', None, None, ), # 16
    (17, TType.STRUCT, 'third_party_storage', (ncThirdPartyStorage, ncThirdPartyStorage.thrift_spec), None, ), # 17
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.storage_media_type = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 15:
        if ftype == TType.STRING:
          self.cache_media_type = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 16:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.storage_media_type is not None:
      oprot.writeFieldBegin('storage_media_type', TType.STRING, 14)
      oprot.writeString(self.storage_media_type.encode('utf-8'))
      oprot.writeFieldEnd()
    if self.cache_media_type is not None:
      oprot.writeFieldBegin('cache_media_type', TType.STRING, 15)
      oprot.writeString(self.cache_media_type.encode('utf-8'))
      oprot.writeFieldEnd()
    if self.pool_id is not None:
      oprot.writeFieldBegin('pool_id', TType.STRING, 16)
      oprot.writeString(self.pool_id.encode('utf-8'))
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.used_size)
    value = (value * 31) ^ hash(self.free_size)
    value = (value * 31) ^ hash(self.redundancy_policy)
    value = (value * 31) ^ hash(self.security_level)
    value = (value * 31) ^ hash(self.replication_factor)
    value = (value * 31) ^ hash(self.num_data_units)
    value = (value * 31) ^ hash(self.num_parity_units)
    value = (value * 31) ^ hash(self.num_fault_tolerance)
    value = (value * 31) ^ hash(self.storage_media_type)
    value = (value * 31) ^ hash(self.cache_media_type)
    value = (value * 31) ^ hash(self.pool_id)
    value = (value * 31) ^ hash(self.third_party_storage)
    return value
...
class ncPoolNode(object):
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.node_ip)
    value = (value * 31) ^ hash(self.start_slot)
    value = (value * 31) ^ hash(self.end_slot)
    value = (value * 31) ^ hash(self.cache_num)
    return value
...
class ncCreatePoolRequest(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'pool', (ncPool, ncPool.thrift_spec), None, ), # 1
    (2, TType.LIST, 'nodes', (TType.STRUCT,(ncPoolNode, ncPoolNode.thrift_spec)), None, ), # 2
  )
...
class ncPutDiskRequest(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'diskId', None, None, ), # 1
...
class ncDeleteSpareDiskRequest(object):
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.loginIp)
    value = (value * 31) ^ hash(self.userName)
    value = (value * 31) ^ hash(self.systemLogType)
    return value
...
class ncNode(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'id', None, None, ), # 1
    (2, TType.STRING, 'manage_ip', None, None, ), # 2
    (3, TType.STRING, 'storage_ip', None, None, ), # 3
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.manage_ip = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.STRING:
          self.storage_ip = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.manage_ip is not None:
      ...
      oprot.writeString(self.manage_ip.encode('utf-8'))
      oprot.writeFieldEnd()
    if self.storage_ip is not None:
      oprot.writeFieldBegin('storage_ip', TType.STRING, 3)
      oprot.writeString(self.storage_ip.encode('utf-8'))
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.id)
    value = (value * 31) ^ hash(self.manage_ip)
    value = (value * 31) ^ hash(self.storage_ip)
    return value
...
class ncRequestDiskLogInfoRequest(object):
  ...
  thrift_spec = (
    ...
    (4, TType.STRING, 'loginIp', None, None, ), # 4
    (5, TType.STRING, 'userName', None, None, ), # 5
    (6, TType.STRING, 'logType', None, None, ), # 6
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.logType = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.logType is not None:
      ...
      oprot.writeString(self.logType.encode('utf-8'))
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class ncMountPath(object):
  ...
  def __init__(self, name=None, path=None, total_size=None, free_size=None, used_size=None,):
    self.name = name
    self.path = path
    self.total_size = total_size
    self.free_size = free_size

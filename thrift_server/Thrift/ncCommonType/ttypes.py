...
class ncKeyValue(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'keyStr', None, None, ), # 1
    (2, TType.STRING, 'valueStr', None, None, ), # 2
  )
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.keyStr = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRING:
          self.valueStr = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.keyStr is not None:
      ...
      oprot.writeString(self.keyStr.encode('utf-8'))
      oprot.writeFieldEnd()
    if self.valueStr is not None:
      oprot.writeFieldBegin('valueStr', TType.STRING, 2)
      oprot.writeString(self.valueStr.encode('utf-8'))
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.keyStr)
    value = (value * 31) ^ hash(self.valueStr)
    return value
...
class ncTwoStringList(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'strList1', (TType.STRING,None), None, ), # 1
    (2, TType.LIST, 'strList2', (TType.STRING,None), None, ), # 2
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.strList1)
    value = (value * 31) ^ hash(self.strList2)
    return value
...
class ncOptions(object):
  ...
  def __init__(self, clientType=thrift_spec[1][4], engineType=thrift_spec[2][4],):
...
class ncCustomerParams(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'partialSign', None, None, ), # 1
    (2, TType.LIST, 'params', (TType.STRUCT,(ncKeyValue, ncKeyValue.thrift_spec)), None, ), # 2
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.partialSign = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.LIST:
  ...
  def write(self, oprot):
    ...
    if self.partialSign is not None:
      ...
      oprot.writeString(self.partialSign.encode('utf-8'))
      oprot.writeFieldEnd()
  ...
  def validate(self):
    if self.partialSign is None:
      raise TProtocol.TProtocolException(message='Required field partialSign is unset!')
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.partialSign)
...
class ncKeyValueCustomerParams(object):
  ...
  def validate(self):
    if self.keyStr is None:
      raise TProtocol.TProtocolException(message='Required field keyStr is unset!')
    if self.params is None:
      raise TProtocol.TProtocolException(message='Required field params is unset!')
    return
...
class ncGetJobsReq(object):
  ...
  thrift_spec = (
    ...
    (2, TType.LIST, 'client_macs', (TType.STRING,None), None, ), # 2
    (3, TType.LIST, 'status', (TType.I32,None), None, ), # 3
  )
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.client_macs)
...
class ncRemoteJob(object):
  ...
  thrift_spec = (
    ...
    (4, TType.STRING, 'authUser', None, None, ), # 4

...
class ncAmsJobType(object):
  ...
  thrift_spec = (
    ...
    (12, TType.MAP, 'srcValue', (TType.STRING,None,TType.STRING,None), None, ), # 12
    (13, TType.MAP, 'dest', (TType.STRING,None,TType.STRING,None), None, ), # 13
    (14, TType.STRING, 'sla', None, None, ), # 14
    (15, TType.LIST, 'schedule', (TType.MAP,(TType.STRING,None,TType.STRING,None)), None, ), # 15
    (16, TType.MAP, 'user', (TType.STRING,None,TType.STRING,None), None, ), # 16
    (17, TType.LIST, 'dataSources', (TType.MAP,(TType.STRING,None,TType.STRING,None)), None, ), # 17
    (18, TType.MAP, 'advParams', (TType.STRING,None,TType.STRING,None), None, ), # 18
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.sla = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 15:
        if ftype == TType.LIST:
        ...
        if ftype == TType.MAP:
          ...
          for _i31 in xrange(_size27):
            _key32 = iprot.readString().decode('utf-8')
            _val33 = iprot.readString().decode('utf-8')
        ...
        if ftype == TType.LIST:
          ...
          for _i38 in xrange(_size34):
            ...
            for _i44 in xrange(_size40):
              _key45 = iprot.readString().decode('utf-8')
              _val46 = iprot.readString().decode('utf-8')
        ...
        if ftype == TType.MAP:
          ...
          for _i51 in xrange(_size47):
            _key52 = iprot.readString().decode('utf-8')
            _val53 = iprot.readString().decode('utf-8')
  ...
  def write(self, oprot):
    ...
    if self.srcValue is not None:
      ...
      for kiter54,viter55 in self.srcValue.items():
        oprot.writeString(kiter54.encode('utf-8'))
        oprot.writeString(viter55.encode('utf-8'))
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.dest is not None:
      ...
      for kiter56,viter57 in self.dest.items():
        ...
        oprot.writeString(viter57.encode('utf-8'))
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.sla is not None:
      oprot.writeFieldBegin('sla', TType.STRING, 14)
      oprot.writeString(self.sla.encode('utf-8'))
      oprot.writeFieldEnd()
    if self.schedule is not None:
      ...
      for iter58 in self.schedule:
        ...
        for kiter59,viter60 in iter58.items():
          oprot.writeString(kiter59.encode('utf-8'))
          oprot.writeString(viter60.encode('utf-8'))
        oprot.writeMapEnd()
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.user is not None:
      ...
      for kiter61,viter62 in self.user.items():
        oprot.writeString(kiter61.encode('utf-8'))
        oprot.writeString(viter62.encode('utf-8'))
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    ...
    if self.advParams is not None:
      ...
      for kiter66,viter67 in self.advParams.items():
        ...
        oprot.writeString(viter67.encode('utf-8'))
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.taskParentType)
    value = (value * 31) ^ hash(self.taskSubType)
...
class ncJobLog(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'taskId', None, None, ), # 1
    (2, TType.STRING, 'logID', None, None, ), # 2
    (3, TType.I32, 'execType', None, None, ), # 3
    (4, TType.I32, 'execStatus', None, None, ), # 4
    (5, TType.I32, 'execResult', None, None, ), # 5
    (6, TType.STRING, 'execDesc', None, None, ), # 6
    (7, TType.I64, 'startTime', None, None, ), # 7
    (8, TType.I64, 'endTime', None, None, ), # 8
    (9, TType.STRING, 'speed', None, None, ), # 9
    (10, TType.STRING, 'totalSize', None, None, ), # 10
    (11, TType.STRING, 'compressedSize', None, None, ), # 11
    (12, TType.STRING, 'deduplicationSize', None, None, ), # 12
    (13, TType.I64, 'calculateTime', None, None, ), # 13
    None, # 14
    (15, TType.I64, 'failureCode', None, None, ), # 15
    (16, TType.STRING, 'failureReason', None, None, ), # 16
    (17, TType.I32, 'srcType', None, None, ), # 17
    (18, TType.I32, 'destType', None, None, ), # 18
    (19, TType.STRING, 'srcId', None, None, ), # 19
    (20, TType.STRING, 'destId', None, None, ), # 20
    (21, TType.STRING, 'srcAdditionName', None, None, ), # 21
    (22, TType.STRING, 'destAdditionName', None, None, ), # 22
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.logID = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.I32:
        ...
        if ftype == TType.STRING:
          self.execDesc = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 7:
        if ftype == TType.I64:
        ...
        if ftype == TType.STRING:
          self.speed = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 10:
        if ftype == TType.STRING:
        ...
        if ftype == TType.STRING:
          self.compressedSize = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 12:
        if ftype == TType.STRING:
          self.deduplicationSize = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 13:
        if ftype == TType.I64:
        ...
        if ftype == TType.STRING:
          self.srcId = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 20:
        if ftype == TType.STRING:
          self.destId = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 21:
        if ftype == TType.STRING:
          self.srcAdditionName = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 22:
        if ftype == TType.STRING:
          self.destAdditionName = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.logID is not None:
      ...
      oprot.writeString(self.logID.encode('utf-8'))
      oprot.writeFieldEnd()
    ...
    if self.execDesc is not None:
      ...
      oprot.writeString(self.execDesc.encode('utf-8'))
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.execStatus)
    value = (value * 31) ^ hash(self.execResult)
    value = (value * 31) ^ hash(self.execDesc)
    ...
    value = (value * 31) ^ hash(self.compressedSize)
    value = (value * 31) ^ hash(self.deduplicationSize)
    value = (value * 31) ^ hash(self.calculateTime)
    value = (value * 31) ^ hash(self.failureCode)
    value = (value * 31) ^ hash(self.failureReason)
    value = (value * 31) ^ hash(self.srcType)
    value = (value * 31) ^ hash(self.destType)
    value = (value * 31) ^ hash(self.srcId)
    value = (value * 31) ^ hash(self.destId)
    value = (value * 31) ^ hash(self.srcAdditionName)
    value = (value * 31) ^ hash(self.destAdditionName)
    return value

...
class ncRestoreObjectEnum(object):
    KINGBASE_INSTANCE = 0
    KINGBASE_TABLE_SPACE = 1
    KINGBASE_DATA_FILE = 2
    KINGBASE_LOG_FILE = 3
    KINGBASE_CONTROL_FILE = 4
    KINGBASE_SPFILE = 5
    KINGBASE_TABLE = 6

    _VALUES_TO_NAMES = {
        0: "KINGBASE_INSTANCE",
        1: "KINGBASE_TABLE_SPACE",
        2: "KINGBASE_DATA_FILE",
        3: "KINGBASE_LOG_FILE",
        4: "KINGBASE_CONTROL_FILE",
        5: "KINGBASE_SPFILE",
        6: "KINGBASE_TABLE",
    }
...
class ncKingBaseClientMetaInfo(object):
    """
    Attributes:
     - attributes
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('ncKingBaseClientMetaInfo')
...
class ncKingBaseBackupMetaInfo(object):
    """
    Attributes:
     - version
     - clienttype
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i13 in range(_size9):
                        _elem14 = ncKingBaseClientMetaInfo()
                        _elem14.read(iprot)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncKingBaseBackupMetaInfo')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(ncKingBaseClientMetaInfo)
ncKingBaseClientMetaInfo.thrift_spec = (
    None,  # 0
    (1, TType.MAP, 'attributes', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 1
)
all_structs.append(ncKingBaseBackupMetaInfo)
ncKingBaseBackupMetaInfo.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'version', None, None, ),  # 1
    (2, TType.I32, 'clienttype', None, None, ),  # 2
    (3, TType.LIST, 'metas', (TType.STRUCT, [ncKingBaseClientMetaInfo, None], False), None, ),  # 3
)

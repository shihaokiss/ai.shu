...
class ncClientMetaInfo(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.machine_code = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.machine_code is not None:
            ...
            oprot.writeString(self.machine_code.encode('utf-8') if sys.version_info[0] == 2 else self.machine_code)
            oprot.writeFieldEnd()
    ...
    def validate(self):
        if self.machine_code is None:
            raise TProtocolException(message='Required field machine_code is unset!')
...
class ncDataConfigInfoSetWrapper(object):
    ...
    def validate(self):
        if self.client_meta is None:
            raise TProtocolException(message='Required field client_meta is unset!')
        if self.data_config_info_set is None:
            raise TProtocolException(message='Required field data_config_info_set is unset!')
        return
...
class ncClientDbUsersEPMS(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(ncDSReqForEPMS)
ncDSReqForEPMS.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'clientId', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'dataSourceRequest', [ncDataSource.ttypes.ncDataSourceRequest, None], None, ),  # 2
)
all_structs.append(ncCheckProcessForEPMS)
ncCheckProcessForEPMS.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'clientId', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'connInfo', [ncEEFJobBase.ttypes.ncEEFConnectionInfo, None], None, ),  # 2
)
all_structs.append(ncJobBaseForEPMS)
ncJobBaseForEPMS.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'clientId', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'baseInfo', [ncEEFJobBase.ttypes.ncEEFBase, None], None, ),  # 2
)
all_structs.append(ncDataConfigInfoSetForEPMS)
ncDataConfigInfoSetForEPMS.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'clientId', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'dataConfigInfoSet', [ncDataSource.ttypes.ncDataConfigInfoSet, None], None, ),  # 2
)
all_structs.append(ncClientMetaInfo)
ncClientMetaInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'machine_code', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'client_id', 'UTF8', None, ),  # 2
)
all_structs.append(ncDataConfigInfoSetWrapper)
ncDataConfigInfoSetWrapper.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'client_meta', [ncClientMetaInfo, None], None, ),  # 1
    (2, TType.STRUCT, 'data_config_info_set', [ncDataSource.ttypes.ncDataConfigInfoSet, None], None, ),  # 2
)
all_structs.append(ncCheckPathParEPMS)
ncCheckPathParEPMS.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'clientId', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'cPath', [ncDataSource.ttypes.ncCheckPathPar, None], None, ),  # 2
)
all_structs.append(ncClientDbUsersEPMS)
ncClientDbUsersEPMS.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'clientId', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'users', [ncDataSource.ttypes.ncOSUSersInfoSet, None], None, ),  # 2
)

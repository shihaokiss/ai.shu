...
class ncEEFJobParams(object):
    ...
    def __init__(self, baseInfo=None, jobType=None, jobProperty=None, jobOption=None, needStop=False,):
...
class ncEEFJobInfo(object):
    ...
    def __init__(self, execId=None, jobType=None, clientType=1, engineType=1001, clientMac=None, jobProperty=None,):
        self.execId = execId
        self.jobType = jobType
...
class ncExecBody(object):
    ...
    def __init__(self, execSpeed=None, completedSize=0, execInfo=None, gns="", remainSize=0, sendSize=0,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.execSpeed = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.I64:
                ...
                if ftype == TType.STRING:
                    self.execInfo = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.execSpeed is not None:
            ...
            oprot.writeString(self.execSpeed.encode('utf-8') if sys.version_info[0] == 2 else self.execSpeed)
            oprot.writeFieldEnd()
        ...
        if self.execInfo is not None:
            ...
            oprot.writeString(self.execInfo.encode('utf-8') if sys.version_info[0] == 2 else self.execInfo)
            oprot.writeFieldEnd()
...
class ncEEFExecReport(object):
    ...
    def __init__(self, baseInfo=None, totalSize=0, sendSize=0, tpGNS=None, actualBakType=None,):
        self.baseInfo = baseInfo
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.actualBakType = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.actualBakType is not None:
            ...
            oprot.writeString(self.actualBakType.encode('utf-8') if sys.version_info[0] == 2 else self.actualBakType)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ncEEFObjectBaseAtr(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.sourceAuthUser = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.sourceAuthUser is not None:
            ...
            oprot.writeString(self.sourceAuthUser.encode('utf-8') if sys.version_info[0] == 2 else self.sourceAuthUser)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ncEEFObjectReportsAtr(object):
    ...
    def __init__(self, is_status=False, status=None, is_messgae=False, execLog=None, is_report=False, execBodyInfo=None, actualBakType=None,):
...
class ncEEFCdmRestoreVmIds(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.vmIds = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.vmIds is not None:
            ...
            oprot.writeString(self.vmIds.encode('utf-8') if sys.version_info[0] == 2 else self.vmIds)
            oprot.writeFieldEnd()
        if self.jobId is not None:
            oprot.writeFieldBegin('jobId', TType.STRING, 2)
            oprot.writeString(self.jobId.encode('utf-8') if sys.version_info[0] == 2 else self.jobId)
...
class ncEEFCdmImageCustomer(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.imageId = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
...
class ncEEFTimePoints(object):
    ...
    def __init__(self, baseInfo=None, timepoint=None, isDataFinished=False, status=None, totalSize=0, sendSize=0, customer=None,):
        self.baseInfo = baseInfo
        self.timepoint = timepoint
...
class ncEEFCleanTimePointInfo(object):
    """
    Attributes:
     - execID
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncEEFCleanTimePointInfo')
        if self.execID is not None:
            oprot.writeFieldBegin('execID', TType.STRING, 1)
            oprot.writeString(self.execID.encode('utf-8') if sys.version_info[0] == 2 else self.execID)
            oprot.writeFieldEnd()
...
class ncEEFHanaRedundancy(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.redundancy = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.redundancy is not None:
            ...
            oprot.writeString(self.redundancy.encode('utf-8') if sys.version_info[0] == 2 else self.redundancy)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ncMongodbBack(object):
    ...
    def __init__(self, execId=None, stopBlancer=None, configBackup=None, shardBackup=None, timePoint=None, clientNum=None, status=None, customer=None,):
        self.execId = execId
...
class ncEEFCreateTimePoint(object):
    ...
    def __init__(self, timePointStatus=0,):
...
class ncUpdateJobDatasource(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.oldFullpath = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
                    self.newFullpath = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.STRING:
                ...
                if ftype == TType.STRING:
                    self.disPath = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.oldFullpath is not None:
            ...
            oprot.writeString(self.oldFullpath.encode('utf-8') if sys.version_info[0] == 2 else self.oldFullpath)
            oprot.writeFieldEnd()
        if self.newFullpath is not None:
            oprot.writeFieldBegin('newFullpath', TType.STRING, 3)
            oprot.writeString(self.newFullpath.encode('utf-8') if sys.version_info[0] == 2 else self.newFullpath)
            oprot.writeFieldEnd()
        ...
        if self.disPath is not None:
            ...
            oprot.writeString(self.disPath.encode('utf-8') if sys.version_info[0] == 2 else self.disPath)
            oprot.writeFieldEnd()
        if self.uuid is not None:
...
class ncEEFDeleteBaseLun(object):
    """
    Attributes:
     - jobId
     - volumeId
    ...
    def __init__(self, jobId=None, volumeId=None,):
        self.jobId = jobId
        self.volumeId = volumeId
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncEEFDeleteBaseLun')
        if self.jobId is not None:
            oprot.writeFieldBegin('jobId', TType.STRING, 1)
            oprot.writeString(self.jobId.encode('utf-8') if sys.version_info[0] == 2 else self.jobId)
            oprot.writeFieldEnd()
...
class ncEEFDeleteBaseLunResponse(object):
    """
    Attributes:
     - isSuccess
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncEEFDeleteBaseLunResponse')
        if self.isSuccess is not None:
            oprot.writeFieldBegin('isSuccess', TType.BOOL, 1)
            oprot.writeBool(self.isSuccess)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(ncEEFJobParams)
ncEEFJobParams.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'baseInfo', [ncEEFJobBase.ttypes.ncEEFBase, None], None, ),  # 1
    (2, TType.STRING, 'jobType', 'UTF8', None, ),  # 2
    (3, TType.LIST, 'jobProperty', (TType.STRUCT, [ncCommonType.ttypes.ncKeyValue, None], False), None, ),  # 3
    (4, TType.STRUCT, 'jobOption', [ncCommonType.ttypes.ncOptions, None], None, ),  # 4
    None,  # 5
    (6, TType.BOOL, 'needStop', None, False, ),  # 6
)
all_structs.append(ncEEFJobInfo)
ncEEFJobInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'execId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'jobType', 'UTF8', None, ),  # 2
    (3, TType.I32, 'clientType', None, 1, ),  # 3
    (4, TType.I32, 'engineType', None, 1001, ),  # 4
    (5, TType.LIST, 'clientMac', (TType.STRING, 'UTF8', False), None, ),  # 5
    (6, TType.LIST, 'jobProperty', (TType.STRUCT, [ncCommonType.ttypes.ncKeyValue, None], False), None, ),  # 6
)
all_structs.append(ncExecBody)
ncExecBody.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'execSpeed', 'UTF8', None, ),  # 1
    (2, TType.I64, 'completedSize', None, 0, ),  # 2
    (3, TType.STRING, 'execInfo', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'gns', 'UTF8', "", ),  # 4
    (5, TType.I64, 'remainSize', None, 0, ),  # 5
    (6, TType.I64, 'sendSize', None, 0, ),  # 6
)
all_structs.append(ncEEFExecProgress)
ncEEFExecProgress.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'baseInfo', [ncEEFJobBase.ttypes.ncEEFBase, None], None, ),  # 1
    (2, TType.STRUCT, 'execBodyInfo', [ncExecBody, None], None, ),  # 2
)
all_structs.append(ncEEFExecReport)
ncEEFExecReport.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'baseInfo', [ncEEFJobBase.ttypes.ncEEFBase, None], None, ),  # 1
    (2, TType.I64, 'totalSize', None, 0, ),  # 2
    (3, TType.I64, 'sendSize', None, 0, ),  # 3
    (4, TType.STRING, 'tpGNS', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'actualBakType', 'UTF8', None, ),  # 5
)
all_structs.append(ncEEFObjectBaseAtr)
ncEEFObjectBaseAtr.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'baseInfo', [ncEEFJobBase.ttypes.ncEEFBase, None], None, ),  # 1
    (2, TType.STRING, 'sourceClusterId', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'sourceAuthUser', 'UTF8', None, ),  # 3
)
all_structs.append(ncEEFObjectReportsAtr)
ncEEFObjectReportsAtr.thrift_spec = (
    None,  # 0
    (1, TType.BOOL, 'is_status', None, False, ),  # 1
    (2, TType.I32, 'status', None, None, ),  # 2
    (3, TType.BOOL, 'is_messgae', None, False, ),  # 3
    (4, TType.STRUCT, 'execLog', [ncEEFJobBase.ttypes.ncExecLog, None], None, ),  # 4
    (5, TType.BOOL, 'is_report', None, False, ),  # 5
    (6, TType.STRUCT, 'execBodyInfo', [ncExecBody, None], None, ),  # 6
    (7, TType.STRING, 'actualBakType', 'UTF8', None, ),  # 7
)
all_structs.append(ncEEFJobReports)
ncEEFJobReports.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'exBaseInfo', [ncEEFObjectBaseAtr, None], None, ),  # 1
    (2, TType.STRING, 'jobId', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'jobName', 'UTF8', None, ),  # 3
    (4, TType.STRUCT, 'jobReport', [ncEEFObjectReportsAtr, None], None, ),  # 4
    (5, TType.MAP, 'tpReportMap', (TType.STRING, 'UTF8', TType.STRUCT, [ncEEFObjectReportsAtr, None], False), None, ),  # 5
)
all_structs.append(ncEEFExtraMetadata)
ncEEFExtraMetadata.thrift_spec = (
    None,  # 0
...
all_structs.append(ncEEFCdmLunInfo)
ncEEFCdmLunInfo.thrift_spec = (
    None,  # 0
    ...
    (6, TType.STRING, 'wwn', 'UTF8', None, ),  # 6
    (7, TType.STRING, 'volumeId', 'UTF8', None, ),  # 7
)
all_structs.append(ncEEFCdmLunInfoLists)
ncEEFCdmLunInfoLists.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'cdmLunInfoLists', (TType.STRUCT, [ncEEFCdmLunInfo, None], False), None, ),  # 1
    (2, TType.STRING, 'jobId', 'UTF8', None, ),  # 2
)
all_structs.append(ncEEFCdmUpdateLunInfo)
ncEEFCdmUpdateLunInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'lunId', 'UTF8', None, ),  # 1
    (2, TType.I64, 'usedSize', None, None, ),  # 2
    (3, TType.STRING, 'fullPath', 'UTF8', None, ),  # 3
)
all_structs.append(ncEEFCdmUpdateLunInfoLists)
ncEEFCdmUpdateLunInfoLists.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'cdmUpdateLunInfoLists', (TType.STRUCT, [ncEEFCdmUpdateLunInfo, None], False), None, ),  # 1
    (2, TType.STRING, 'jobId', 'UTF8', None, ),  # 2
)
all_structs.append(ncEEFCreateLun)
ncEEFCreateLun.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'jobId', 'UTF8', None, ),  # 1
...
all_structs.append(ncEEFOpenStackAction)
ncEEFOpenStackAction.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'clientMac', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'request', 'UTF8', None, ),  # 2
)
all_structs.append(ncEEFOpenStackActionResult)
ncEEFOpenStackActionResult.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'result', 'UTF8', None, ),  # 1
)
all_structs.append(ncEEFCdmRestoreVmIds)
ncEEFCdmRestoreVmIds.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'vmIds', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'jobId', 'UTF8', None, ),  # 2
)
all_structs.append(ncEEFCdmImageCustomer)
ncEEFCdmImageCustomer.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'imageId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'customer', 'UTF8', None, ),  # 2
)
all_structs.append(ncEEFTimePoints)
ncEEFTimePoints.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'baseInfo', [ncEEFJobBase.ttypes.ncEEFBase, None], None, ),  # 1
    (2, TType.I64, 'timepoint', None, None, ),  # 2
    ...
    (6, TType.I64, 'sendSize', None, 0, ),  # 6
    (7, TType.STRING, 'customer', 'UTF8', None, ),  # 7
)
all_structs.append(ncEEFCleanTimePointInfo)
ncEEFCleanTimePointInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'execID', 'UTF8', None, ),  # 1
)
all_structs.append(ncEEFHanaRedundancy)
ncEEFHanaRedundancy.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'baseInfo', [ncEEFJobBase.ttypes.ncEEFBase, None], None, ),  # 1
    (2, TType.STRING, 'redundancy', 'UTF8', None, ),  # 2
)
all_structs.append(ncEEFDeleteLun)
ncEEFDeleteLun.thrift_spec = (
    None,  # 0
    (1, TType.BOOL, 'isSuccess', None, None, ),  # 1
)
all_structs.append(ncMongodbBack)
ncMongodbBack.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'execId', 'UTF8', None, ),  # 1
...
all_structs.append(ncEEFCreateTimePoint)
ncEEFCreateTimePoint.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'timePointStatus', None, 0, ),  # 1
)
all_structs.append(ncEEFBaseLunInfo)
ncEEFBaseLunInfo.thrift_spec = (
    None,  # 0
...
all_structs.append(ncEEFBaseLunInfoLists)
ncEEFBaseLunInfoLists.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'cdmBaseLunInfoLists', (TType.STRUCT, [ncEEFBaseLunInfo, None], False), None, ),  # 1
)
all_structs.append(ncEEFCreateLunMapping)
ncEEFCreateLunMapping.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'cdmBaseLunInfoLists', (TType.STRUCT, [ncEEFBaseLunInfo, None], False), None, ),  # 1
    (2, TType.STRING, 'jobId', 'UTF8', None, ),  # 2
    (3, TType.I64, 'size', None, None, ),  # 3
    (4, TType.STRING, 'execId', 'UTF8', None, ),  # 4
)
all_structs.append(ncEEFDeleteBaseLunInfo)
ncEEFDeleteBaseLunInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'volumeId', 'UTF8', None, ),  # 1
    (2, TType.I32, 'volumeType', None, None, ),  # 2
    (3, TType.STRING, 'errorMgm', 'UTF8', None, ),  # 3
)
all_structs.append(ncEEFDeleteLunMapping)
ncEEFDeleteLunMapping.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'cdmDeleteLunInfoLists', (TType.STRUCT, [ncEEFDeleteBaseLunInfo, None], False), None, ),  # 1
    (2, TType.STRING, 'jobId', 'UTF8', None, ),  # 2
)
all_structs.append(ncEEFCheckLunMapping)
ncEEFCheckLunMapping.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'jobId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'execId', 'UTF8', None, ),  # 2
)
all_structs.append(ncEEFCheckLunMappingResponse)
ncEEFCheckLunMappingResponse.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'finished', None, None, ),  # 1
    (2, TType.LIST, 'cdmLunMapInfos', (TType.STRUCT, [ncEEFCdmLunInfo, None], False), None, ),  # 2
)
all_structs.append(ncEEFCheckDeleteLunMappingResponse)
ncEEFCheckDeleteLunMappingResponse.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'finished', None, None, ),  # 1
    (2, TType.LIST, 'cdmDeleteLunInfoLists', (TType.STRUCT, [ncEEFDeleteBaseLunInfo, None], False), None, ),  # 2
)
all_structs.append(ncUpdateJobDatasource)
ncUpdateJobDatasource.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'jobId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'oldFullpath', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'newFullpath', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'reply', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'disPath', 'UTF8', None, ),  # 5
    (6, TType.STRING, 'uuid', 'UTF8', None, ),  # 6
)
all_structs.append(ncEEFDeleteBaseLun)
ncEEFDeleteBaseLun.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'jobId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'volumeId', 'UTF8', None, ),  # 2
)
all_structs.append(ncEEFDeleteBaseLunResponse)
ncEEFDeleteBaseLunResponse.thrift_spec = (
    None,  # 0
    (1, TType.BOOL, 'isSuccess', None, None, ),  # 1
)

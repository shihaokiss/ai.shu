...
class ncLogEvent(object):
    ...
    MANUAL_SYNC_SUBLICENSE = 76
    AUTO_SYNC_SUBLICENSE = 77
    SET_PROXY_USER = 78
    DOWNLOAD = 79
    UPLOAD = 80
    SET = 81
    THRESHOLD_EXCEEDED = 82
    EXPIRED = 83
    SNAP_ALARM_THRESHOLD = 84
    SNAP_SAFE_THRESHOLD = 85
    SNAP_ABNORMAL = 86
    VOLUME_THRESHOLD_EXCEEDED = 87
    VOLUME_ABNORMAL = 88
    UNKNOWN = 100
    ...
    _VALUES_TO_NAMES = {
        ...
        76: "MANUAL_SYNC_SUBLICENSE",
        77: "AUTO_SYNC_SUBLICENSE",
        78: "SET_PROXY_USER",
        79: "DOWNLOAD",
        80: "UPLOAD",
        81: "SET",
        82: "THRESHOLD_EXCEEDED",
        83: "EXPIRED",
        84: "SNAP_ALARM_THRESHOLD",
        85: "SNAP_SAFE_THRESHOLD",
        86: "SNAP_ABNORMAL",
        87: "VOLUME_THRESHOLD_EXCEEDED",
        88: "VOLUME_ABNORMAL",
        100: "UNKNOWN",
    }
...
class ncCommonLog(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.excObject = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.I32:
                ...
                if ftype == TType.STRING:
                    self.errContent = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.BOOL:
                ...
                if ftype == TType.STRING:
                    self.logContent = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.excObject is not None:
            ...
            oprot.writeString(self.excObject.encode('utf-8') if sys.version_info[0] == 2 else self.excObject)
            oprot.writeFieldEnd()
        ...
        if self.errContent is not None:
            ...
            oprot.writeString(self.errContent.encode('utf-8') if sys.version_info[0] == 2 else self.errContent)
            oprot.writeFieldEnd()
        ...
        if self.logContent is not None:
            ...
            oprot.writeString(self.logContent.encode('utf-8') if sys.version_info[0] == 2 else self.logContent)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        if self.sTime is None:
            raise TProtocolException(message='Required field sTime is unset!')
        if self.executor is None:
            raise TProtocolException(message='Required field executor is unset!')
        if self.excObject is None:
            raise TProtocolException(message='Required field excObject is unset!')
        if self.logEvent is None:
            raise TProtocolException(message='Required field logEvent is unset!')
        if self.result is None:
            raise TProtocolException(message='Required field result is unset!')
        if self.errContent is None:
            raise TProtocolException(message='Required field errContent is unset!')
        if self.needWarn is None:
            raise TProtocolException(message='Required field needWarn is unset!')
        ...
        if self.logContent is None:
            raise TProtocolException(message='Required field logContent is unset!')
        return
...
class ncSystemLog(object):
    ...
    def __init__(self, log=None, logType=1, customer=None,):
        self.log = log
    ...
    def validate(self):
        ...
        if self.logType is None:
            raise TProtocolException(message='Required field logType is unset!')
        if self.customer is None:
            raise TProtocolException(message='Required field customer is unset!')
        return
...
class ncScheduleLog(object):
    ...
    def __init__(self, log=None, protectType=None, dataType=None, clientId=None, logType=4, customer=None,):
        self.log = log
        self.protectType = protectType
...
class ncExportLogReq(object):
    ...
    def __init__(self, fileFormat=None, fileName=None, requestId=None, method=None, filterParams=None, passWord=None, uuidStr=None, userName=None, userRole=None, loginIp=None, userId=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.uuidStr = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.uuidStr is not None:
            ...
            oprot.writeString(self.uuidStr.encode('utf-8') if sys.version_info[0] == 2 else self.uuidStr)
            oprot.writeFieldEnd()
...
class ncSystemRuleReq(object):
    ...
    def __init__(self, level=None, eventType=None, logEvent=None,):
        self.level = level
        self.eventType = eventType
        self.logEvent = logEvent
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncSystemRuleReq')
        if self.level is not None:
        ...
        if self.eventType is not None:
            ...
            oprot.writeFieldEnd()
        if self.logEvent is not None:
            oprot.writeFieldBegin('logEvent', TType.I32, 3)
            oprot.writeI32(self.logEvent)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ncImportLogReq(object):
    ...
    def __init__(self, fileFormat=None, fileName=None, requestId=None, method=None, userName=None, userRole=None, loginIp=None,):
        self.fileFormat = fileFormat
        self.fileName = fileName
        self.requestId = requestId
        self.method = method
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncImportLogReq')
        if self.fileFormat is not None:
            oprot.writeFieldBegin('fileFormat', TType.STRING, 1)
            oprot.writeString(self.fileFormat.encode('utf-8') if sys.version_info[0] == 2 else self.fileFormat)
            oprot.writeFieldEnd()
        ...
        if self.userName is not None:
            ...
            oprot.writeFieldEnd()
        if self.userRole is not None:
            oprot.writeFieldBegin('userRole', TType.I32, 6)
            oprot.writeI32(self.userRole)
            oprot.writeFieldEnd()
        if self.loginIp is not None:
            oprot.writeFieldBegin('loginIp', TType.STRING, 7)
            oprot.writeString(self.loginIp.encode('utf-8') if sys.version_info[0] == 2 else self.loginIp)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ncImportLogRes(object):
    ...
    def __init__(self, requestId=None, isFinished=None, isErr=None, errs=None,):
        self.requestId = requestId
        self.isFinished = isFinished
        self.isErr = isErr
        self.errs = errs
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncImportLogRes')
        if self.requestId is not None:
            oprot.writeFieldBegin('requestId', TType.STRING, 1)
            oprot.writeString(self.requestId.encode('utf-8') if sys.version_info[0] == 2 else self.requestId)
            oprot.writeFieldEnd()
...
class ncExportOverviewRes(object):
    ...
    def __init__(self, requestId=None, isFinished=None, nodeId=None, fileName=None, isErr=None, err=None,):
        self.requestId = requestId
        self.isFinished = isFinished
        self.nodeId = nodeId
        self.fileName = fileName
    ...
    def write(self, oprot):
        ...
        if self.err is not None:
            oprot.writeFieldBegin('err', TType.STRING, 6)
...
class ncUserWarnRuleSettings(object):
    """
    Attributes:
     - userId
     - isEmail
    ...
    def __init__(self, userId=None, isEmail=None, isGlobal=None, parameter=None,):
        self.userId = userId
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncUserWarnRuleSettings')
        if self.userId is not None:
        ...
        if self.isGlobal is not None:
            oprot.writeFieldBegin('isGlobal', TType.BOOL, 3)
            oprot.writeBool(self.isGlobal)
            oprot.writeFieldEnd()
        if self.parameter is not None:
            oprot.writeFieldBegin('parameter', TType.LIST, 4)
            oprot.writeListBegin(TType.STRING, len(self.parameter))
            for iter29 in self.parameter:
...
class ncUserWarnRuleSettingsRes(object):
    """
    Attributes:
     - totalNum
     - user_warn_rule_settings

    """


    def __init__(self, totalNum=None, user_warn_rule_settings=None,):
        self.totalNum = totalNum
        self.user_warn_rule_settings = user_warn_rule_settings
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    self.user_warn_rule_settings = []
                    (_etype33, _size30) = iprot.readListBegin()
                    for _i34 in range(_size30):
                        _elem35 = ncUserWarnRuleSettings()
                        _elem35.read(iprot)
                        self.user_warn_rule_settings.append(_elem35)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncUserWarnRuleSettingsRes')
        if self.totalNum is not None:
            oprot.writeFieldBegin('totalNum', TType.I64, 1)
            oprot.writeI64(self.totalNum)
            oprot.writeFieldEnd()
        if self.user_warn_rule_settings is not None:
            oprot.writeFieldBegin('user_warn_rule_settings', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.user_warn_rule_settings))
            for iter36 in self.user_warn_rule_settings:
                iter36.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class ncUserWarn(object):
    ...
    def __init__(self, log=None, role=None, customer=None, type=None, isInsert=None,):
        self.log = log
        self.role = role
        self.customer = customer
        self.type = type
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncUserWarn')
        if self.log is not None:
            oprot.writeFieldBegin('log', TType.STRUCT, 1)
            self.log.write(oprot)
            oprot.writeFieldEnd()
        ...
        if self.type is not None:
            ...
            oprot.writeFieldEnd()
        if self.isInsert is not None:
            oprot.writeFieldBegin('isInsert', TType.BOOL, 5)
            oprot.writeBool(self.isInsert)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        ...
        if self.isInsert is None:
            raise TProtocolException(message='Required field isInsert is unset!')
        return
...
class ncAllWarnModify(object):
    ...
    def __init__(self, warnType=None, user=None, loginIp=None, requestId=None, protectType=None, dataType=None,):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncAllWarnModify')
        if self.warnType is not None:
            oprot.writeFieldBegin('warnType', TType.I32, 1)
            oprot.writeI32(self.warnType)
            oprot.writeFieldEnd()
        if self.user is not None:
            ...
            oprot.writeFieldEnd()
        if self.loginIp is not None:
            oprot.writeFieldBegin('loginIp', TType.STRING, 3)
            oprot.writeString(self.loginIp.encode('utf-8') if sys.version_info[0] == 2 else self.loginIp)
            oprot.writeFieldEnd()
        if self.requestId is not None:
            ...
            oprot.writeFieldEnd()
        if self.protectType is not None:
            oprot.writeFieldBegin('protectType', TType.I32, 5)
            oprot.writeI32(self.protectType)
            oprot.writeFieldEnd()
        if self.dataType is not None:
            oprot.writeFieldBegin('dataType', TType.I32, 6)
            oprot.writeI32(self.dataType)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ncAllWarnModifyRes(object):
    """
    Attributes:
     - requestId
     - isFinished
    ...
    def __init__(self, requestId=None, isFinished=None, isErr=None, err=None,):
        self.requestId = requestId
        self.isFinished = isFinished
        self.isErr = isErr
        self.err = err
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncAllWarnModifyRes')
        if self.requestId is not None:
            oprot.writeFieldBegin('requestId', TType.STRING, 1)
            oprot.writeString(self.requestId.encode('utf-8') if sys.version_info[0] == 2 else self.requestId)
            oprot.writeFieldEnd()
        ...
        if self.isErr is not None:
            ...
            oprot.writeFieldEnd()
        if self.err is not None:
            oprot.writeFieldBegin('err', TType.STRING, 4)
            oprot.writeString(self.err.encode('utf-8') if sys.version_info[0] == 2 else self.err)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(ncLogSaveTime)
ncLogSaveTime.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'name', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'value', 'UTF8', None, ),  # 2
)
all_structs.append(ncCommonLog)
ncCommonLog.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'sTime', None, None, ),  # 1
    (2, TType.STRING, 'executor', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'excObject', 'UTF8', None, ),  # 3
    (4, TType.I32, 'logEvent', None, None, ),  # 4
    (5, TType.I32, 'result', None, None, ),  # 5
    (6, TType.STRING, 'errContent', 'UTF8', None, ),  # 6
    (7, TType.BOOL, 'needWarn', None, None, ),  # 7
    (8, TType.I32, 'level', None, None, ),  # 8
    (9, TType.I32, 'eventType', None, None, ),  # 9
    (10, TType.STRING, 'logContent', 'UTF8', None, ),  # 10
)
all_structs.append(ncSystemLog)
ncSystemLog.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'log', [ncCommonLog, None], None, ),  # 1
    (2, TType.I32, 'logType', None, 1, ),  # 2
    (3, TType.STRING, 'customer', 'UTF8', None, ),  # 3
)
all_structs.append(ncUserLog)
ncUserLog.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'log', [ncCommonLog, None], None, ),  # 1
...
all_structs.append(ncScheduleLog)
ncScheduleLog.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'log', [ncCommonLog, None], None, ),  # 1
...
all_structs.append(ncExportLogReq)
ncExportLogReq.thrift_spec = (
    None,  # 0
    ...
    (5, TType.MAP, 'filterParams', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 5
    (6, TType.STRING, 'passWord', 'UTF8', None, ),  # 6
    (7, TType.STRING, 'uuidStr', 'UTF8', None, ),  # 7
    (8, TType.STRING, 'userName', 'UTF8', None, ),  # 8
    (9, TType.I32, 'userRole', None, None, ),  # 9
    (10, TType.STRING, 'loginIp', 'UTF8', None, ),  # 10
    (11, TType.STRING, 'userId', 'UTF8', None, ),  # 11
)
all_structs.append(ncExportLogRes)
ncExportLogRes.thrift_spec = (
    None,  # 0
...
all_structs.append(ncSystemRuleReq)
ncSystemRuleReq.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'level', None, None, ),  # 1
    (2, TType.I32, 'eventType', None, None, ),  # 2
    (3, TType.I32, 'logEvent', None, None, ),  # 3
)
all_structs.append(ncImportLogReq)
ncImportLogReq.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'fileFormat', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'fileName', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'requestId', 'UTF8', None, ),  # 3
    ...
    (6, TType.I32, 'userRole', None, None, ),  # 6
    (7, TType.STRING, 'loginIp', 'UTF8', None, ),  # 7
)
all_structs.append(ncImportLogRes)
ncImportLogRes.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'requestId', 'UTF8', None, ),  # 1
    (2, TType.BOOL, 'isFinished', None, None, ),  # 2
...
all_structs.append(ncExportOverviewRequest)
ncExportOverviewRequest.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'requestId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'fileFormat', 'UTF8', None, ),  # 2
    (3, TType.I32, 'timeType', None, None, ),  # 3
    (4, TType.I32, 'isExpress', None, None, ),  # 4
    (5, TType.I32, 'isFX18000', None, None, ),  # 5
    (6, TType.STRUCT, 'user', [ncUser.ttypes.ncUserInfo, None], None, ),  # 6
)
all_structs.append(ncExportOverviewRes)
ncExportOverviewRes.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'requestId', 'UTF8', None, ),  # 1
    (2, TType.BOOL, 'isFinished', None, None, ),  # 2
    ...
    (4, TType.STRING, 'fileName', 'UTF8', None, ),  # 4
    (5, TType.BOOL, 'isErr', None, None, ),  # 5
    (6, TType.STRING, 'err', 'UTF8', None, ),  # 6
)
all_structs.append(ncUserWarnRuleSettings)
ncUserWarnRuleSettings.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'userId', 'UTF8', None, ),  # 1
    (2, TType.BOOL, 'isEmail', None, None, ),  # 2
    (3, TType.BOOL, 'isGlobal', None, None, ),  # 3
    (4, TType.LIST, 'parameter', (TType.STRING, 'UTF8', False), None, ),  # 4
)
all_structs.append(ncUserWarnRuleSettingsRes)
ncUserWarnRuleSettingsRes.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'totalNum', None, None, ),  # 1
    (2, TType.LIST, 'user_warn_rule_settings', (TType.STRUCT, [ncUserWarnRuleSettings, None], False), None, ),  # 2
)
all_structs.append(ncUserWarn)
ncUserWarn.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'log', [ncCommonLog, None], None, ),  # 1
    (2, TType.I32, 'role', None, None, ),  # 2
    (3, TType.STRING, 'customer', 'UTF8', None, ),  # 3
    (4, TType.I32, 'type', None, None, ),  # 4
    (5, TType.BOOL, 'isInsert', None, None, ),  # 5
)
all_structs.append(ncAllWarnModify)
ncAllWarnModify.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'warnType', None, None, ),  # 1
    (2, TType.STRUCT, 'user', [ncUser.ttypes.ncUserInfo, None], None, ),  # 2
    (3, TType.STRING, 'loginIp', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'requestId', 'UTF8', None, ),  # 4
    (5, TType.I32, 'protectType', None, None, ),  # 5
    (6, TType.I32, 'dataType', None, None, ),  # 6
)
all_structs.append(ncAllWarnModifyRes)
ncAllWarnModifyRes.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'requestId', 'UTF8', None, ),  # 1
    (2, TType.BOOL, 'isFinished', None, None, ),  # 2
    (3, TType.BOOL, 'isErr', None, None, ),  # 3
    (4, TType.STRING, 'err', 'UTF8', None, ),  # 4
)

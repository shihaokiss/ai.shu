...
class ncThriftVmInfo(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.srcVmId = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
                    self.srcVmName = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.srcVmId is not None:
            ...
            oprot.writeString(self.srcVmId.encode('utf-8') if sys.version_info[0] == 2 else self.srcVmId)
            oprot.writeFieldEnd()
        if self.srcVmName is not None:
            oprot.writeFieldBegin('srcVmName', TType.STRING, 2)
            oprot.writeString(self.srcVmName.encode('utf-8') if sys.version_info[0] == 2 else self.srcVmName)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ncThriftVmVolumeInfo(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.basevolume = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.STRING:
                    self.disp_path = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
                    self.vmInfo = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.basevolume is not None:
            ...
            oprot.writeString(self.basevolume.encode('utf-8') if sys.version_info[0] == 2 else self.basevolume)
            oprot.writeFieldEnd()
        if self.disp_path is not None:
            oprot.writeFieldBegin('disp_path', TType.STRING, 4)
            oprot.writeString(self.disp_path.encode('utf-8') if sys.version_info[0] == 2 else self.disp_path)
            oprot.writeFieldEnd()
        if self.vmInfo is not None:
            oprot.writeFieldBegin('vmInfo', TType.STRING, 5)
            oprot.writeString(self.vmInfo.encode('utf-8') if sys.version_info[0] == 2 else self.vmInfo)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ncDataSource(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.sourceUuid = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.sourceUuid is not None:
            ...
            oprot.writeString(self.sourceUuid.encode('utf-8') if sys.version_info[0] == 2 else self.sourceUuid)
            oprot.writeFieldEnd()
...
class ncJobMapVolume(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.volumeMountPoint = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 13:
                if ftype == TType.STRING:
                    self.relevantMountPoint = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 14:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.volumeMountPoint is not None:
            ...
            oprot.writeString(self.volumeMountPoint.encode('utf-8') if sys.version_info[0] == 2 else self.volumeMountPoint)
            oprot.writeFieldEnd()
        if self.relevantMountPoint is not None:
            oprot.writeFieldBegin('relevantMountPoint', TType.STRING, 13)
            oprot.writeString(self.relevantMountPoint.encode('utf-8') if sys.version_info[0] == 2 else self.relevantMountPoint)
            oprot.writeFieldEnd()
        if self.lunConfig is not None:
...
class ncOriginJob(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.jobVplatformIp = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 23:
                if ftype == TType.STRING:
                    self.jobVplatformName = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 24:
                if ftype == TType.I64:
                ...
                if ftype == TType.STRING:
                    self.originId = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 32:
                if ftype == TType.STRING:
                    self.originClientInfo = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 33:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.jobVplatformIp is not None:
            ...
            oprot.writeString(self.jobVplatformIp.encode('utf-8') if sys.version_info[0] == 2 else self.jobVplatformIp)
            oprot.writeFieldEnd()
        if self.jobVplatformName is not None:
            oprot.writeFieldBegin('jobVplatformName', TType.STRING, 23)
            oprot.writeString(self.jobVplatformName.encode('utf-8') if sys.version_info[0] == 2 else self.jobVplatformName)
            oprot.writeFieldEnd()
        ...
        if self.originId is not None:
            ...
            oprot.writeString(self.originId.encode('utf-8') if sys.version_info[0] == 2 else self.originId)
            oprot.writeFieldEnd()
        if self.originClientInfo is not None:
            oprot.writeFieldBegin('originClientInfo', TType.STRING, 32)
            oprot.writeString(self.originClientInfo.encode('utf-8') if sys.version_info[0] == 2 else self.originClientInfo)
            oprot.writeFieldEnd()
        if self.customer is not None:
...
class ncTimePointVolumeInfo(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.baseVolumeName = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.I16:
                ...
                if ftype == TType.STRING:
                    self.baseVolumeMountPoint = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.I64:
    ...
    def write(self, oprot):
        ...
        if self.baseVolumeName is not None:
            ...
            oprot.writeString(self.baseVolumeName.encode('utf-8') if sys.version_info[0] == 2 else self.baseVolumeName)
            oprot.writeFieldEnd()
        ...
        if self.baseVolumeMountPoint is not None:
            ...
            oprot.writeString(self.baseVolumeMountPoint.encode('utf-8') if sys.version_info[0] == 2 else self.baseVolumeMountPoint)
            oprot.writeFieldEnd()
...
class ncTimePointExtra(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.extraId = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
                ...
                if ftype == TType.STRING:
                    self.distName = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.extraId is not None:
            ...
            oprot.writeString(self.extraId.encode('utf-8') if sys.version_info[0] == 2 else self.extraId)
            oprot.writeFieldEnd()
        if self.name is not None:
            oprot.writeFieldBegin('name', TType.STRING, 2)
            oprot.writeString(self.name.encode('utf-8') if sys.version_info[0] == 2 else self.name)
        ...
        if self.distName is not None:
            ...
            oprot.writeString(self.distName.encode('utf-8') if sys.version_info[0] == 2 else self.distName)
            oprot.writeFieldEnd()
...
class ncCanSyncJobRequest(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.senderJobId = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.senderJobId is not None:
            ...
            oprot.writeString(self.senderJobId.encode('utf-8') if sys.version_info[0] == 2 else self.senderJobId)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ncErrorInformation(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.tpId = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.I64:
    ...
    def write(self, oprot):
        ...
        if self.tpId is not None:
            ...
            oprot.writeString(self.tpId.encode('utf-8') if sys.version_info[0] == 2 else self.tpId)
            oprot.writeFieldEnd()
        if self.startTime is not None:
...
class ncTimePointsRequest(object):
    ...
    def __init__(self, originJobId=None, index=0, count=15,):
        self.originJobId = originJobId
        self.index = index
        self.count = count
...
class ncBaseRequest(object):
    ...
    def __init__(self, userId=None, index=0, count=15,):
        self.userId = userId
        self.index = index
        self.count = count
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncBaseRequest')
        if self.userId is not None:
...
class ncBackupJobsResponse(object):
    """
    获取备份任务对应的所有时间点的返回体
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i172 in range(_size168):
                        _elem173 = ncJob.ttypes.ncTJob()
                        _elem173.read(iprot)
                        self.datas.append(_elem173)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ncBackupJobsResponse')
        if self.totalNum is not None:
            oprot.writeFieldBegin('totalNum', TType.I16, 1)
            oprot.writeI16(self.totalNum)
            oprot.writeFieldEnd()
...
ncImage.thrift_spec = (
    ...
    (6, TType.STRING, 'poolId', 'UTF8', None, ),  # 6
)
all_structs.append(ncThriftCdmLunInfo)
ncThriftCdmLunInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'lunId', 'UTF8', None, ),  # 1
    (2, TType.I64, 'totalSize', None, None, ),  # 2
    (3, TType.I64, 'usedSize', None, None, ),  # 3
    (4, TType.STRING, 'fullPath', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'lunConfig', 'UTF8', None, ),  # 5
)
all_structs.append(ncCdmLunInfoList)
ncCdmLunInfoList.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'cdmLunInfoList', (TType.STRUCT, [ncThriftCdmLunInfo, None], False), None, ),  # 1
)
all_structs.append(ncThriftVmInfo)
ncThriftVmInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'srcVmId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'srcVmName', 'UTF8', None, ),  # 2
)
all_structs.append(ncThriftVmVolumeInfo)
ncThriftVmVolumeInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'srcVmId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'srcVmName', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'basevolume', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'disp_path', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'vmInfo', 'UTF8', None, ),  # 5
)
all_structs.append(ncRequestVmInfo)
ncRequestVmInfo.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'vmInfos', (TType.STRUCT, [ncThriftVmInfo, None], False), None, ),  # 1
)
all_structs.append(ncRequestVmVolumeInfo)
ncRequestVmVolumeInfo.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'vmVolumes', (TType.STRUCT, [ncThriftVmVolumeInfo, None], False), None, ),  # 1
)
all_structs.append(ncLinkConfig)
ncLinkConfig.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'linkType', None, None, ),  # 1
    (2, TType.STRING, 'hostWwn', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'hostId', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'jobId', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'configId', 'UTF8', None, ),  # 5
    (6, TType.STRING, 'linkId', 'UTF8', None, ),  # 6
)
...
ncDataSource.thrift_spec = (
    ...
    (4, TType.STRING, 'sourceUuid', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'dbRunUserName', 'UTF8', None, ),  # 5
    (6, TType.I64, 'createTime', None, None, ),  # 6
    (7, TType.I64, 'updateTime', None, None, ),  # 7
    (8, TType.STRING, 'jobId', 'UTF8', None, ),  # 8
    (9, TType.STRING, 'clientId', 'UTF8', None, ),  # 9
    (10, TType.I16, 'nodeType', None, None, ),  # 10
    (11, TType.STRING, 'baseVolume', 'UTF8', None, ),  # 11
)
all_structs.append(ncAdvParameter)
ncAdvParameter.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'key', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'value', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'jobId', 'UTF8', None, ),  # 3
)
all_structs.append(ncJobMapVolume)
ncJobMapVolume.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'jobId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'volumeId', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'poolId', 'UTF8', None, ),  # 3
    (4, TType.I16, 'poolType', None, None, ),  # 4
    (5, TType.STRING, 'volumeName', 'UTF8', None, ),  # 5
    (6, TType.STRING, 'volumeWwn', 'UTF8', None, ),  # 6
    ...
    (12, TType.STRING, 'volumeMountPoint', 'UTF8', None, ),  # 12
    (13, TType.STRING, 'relevantMountPoint', 'UTF8', None, ),  # 13
    (14, TType.STRING, 'lunConfig', 'UTF8', None, ),  # 14
)
all_structs.append(ncExtraMetaData)
ncExtraMetaData.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'jobId', 'UTF8', None, ),  # 1
...
all_structs.append(ncOriginJob)
ncOriginJob.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'id', 'UTF8', None, ),  # 1
    ...
    (15, TType.STRING, 'hostId', 'UTF8', None, ),  # 15
    (16, TType.STRING, 'poolId', 'UTF8', None, ),  # 16
    (17, TType.I16, 'poolType', None, None, ),  # 17
    (18, TType.STRING, 'baseVolumeId', 'UTF8', None, ),  # 18
    (19, TType.STRING, 'strategyId', 'UTF8', None, ),  # 19
    (20, TType.STRING, 'userId', 'UTF8', None, ),  # 20
    (21, TType.STRING, 'jobVplatformId', 'UTF8', None, ),  # 21
    (22, TType.STRING, 'jobVplatformIp', 'UTF8', None, ),  # 22
    (23, TType.STRING, 'jobVplatformName', 'UTF8', None, ),  # 23
    (24, TType.I64, 'lastMetaDataTimePoint', None, None, ),  # 24
    (25, TType.I32, 'syncType', None, None, ),  # 25
    (26, TType.BOOL, 'isSync', None, None, ),  # 26
    (27, TType.LIST, 'linkConfigs', (TType.STRUCT, [ncLinkConfig, None], False), None, ),  # 27
    (28, TType.LIST, 'dataSources', (TType.STRUCT, [ncDataSource, None], False), None, ),  # 28
    (29, TType.LIST, 'advParams', (TType.STRUCT, [ncAdvParameter, None], False), None, ),  # 29
    (30, TType.LIST, 'jobMapVolumes', (TType.STRUCT, [ncJobMapVolume, None], False), None, ),  # 30
    (31, TType.STRING, 'originId', 'UTF8', None, ),  # 31
    (32, TType.STRING, 'originClientInfo', 'UTF8', None, ),  # 32
    (33, TType.STRING, 'customer', 'UTF8', None, ),  # 33
    (34, TType.I16, 'storageType', None, None, ),  # 34
)
all_structs.append(ncTimePointVolumeInfo)
ncTimePointVolumeInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'snapVolumeId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'snapVolumeUuid', 'UTF8', None, ),  # 2
    (3, TType.I64, 'snapVolumeSize', None, None, ),  # 3
    (4, TType.STRING, 'baseVolumeId', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'baseVolumeUuid', 'UTF8', None, ),  # 5
    (6, TType.STRING, 'baseVolumeName', 'UTF8', None, ),  # 6
    (7, TType.I16, 'baseVolumeAppType', None, None, ),  # 7
    (8, TType.STRING, 'baseVolumeMountPoint', 'UTF8', None, ),  # 8
    (9, TType.I64, 'baseVolumeSize', None, None, ),  # 9
    (10, TType.STRING, 'poolId', 'UTF8', None, ),  # 10
    (11, TType.I16, 'poolType', None, None, ),  # 11
)
all_structs.append(ncTimePointExtra)
ncTimePointExtra.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'extraId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'name', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'distName', 'UTF8', None, ),  # 3
...
ncTimePointInfo.thrift_spec = (
    ...
    (8, TType.LIST, 'volumeInfos', (TType.STRUCT, [ncTimePointVolumeInfo, None], False), None, ),  # 8
    (9, TType.LIST, 'timePointExtras', (TType.STRUCT, [ncTimePointExtra, None], False), None, ),  # 9
    (10, TType.LIST, 'extraMetaDatas', (TType.STRUCT, [ncExtraMetaData, None], False), None, ),  # 10
    (11, TType.I64, 'capSize', None, None, ),  # 11
    (12, TType.I32, 'status', None, None, ),  # 12
    (13, TType.STRING, 'id', 'UTF8', None, ),  # 13
)
all_structs.append(ncAuthUserInfo)
ncAuthUserInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'userName', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'clusterGuid', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'clusterIp', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'verifyCode', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'jobId', 'UTF8', None, ),  # 5
    (6, TType.I16, 'level', None, None, ),  # 6
)
all_structs.append(ncReservedTime)
ncReservedTime.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'unit', None, None, ),  # 1
    (2, TType.I16, 'time', None, None, ),  # 2
)
all_structs.append(ncCreateSyncJobRequest)
ncCreateSyncJobRequest.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'originJob', [ncOriginJob, None], None, ),  # 1
    (2, TType.STRUCT, 'orginalInfo', [ncAuthUserInfo, None], None, ),  # 2
    (3, TType.LIST, 'senderInfo', (TType.STRUCT, [ncAuthUserInfo, None], False), None, ),  # 3
    (4, TType.LIST, 'recipientInfo', (TType.STRUCT, [ncAuthUserInfo, None], False), None, ),  # 4
    (5, TType.STRUCT, 'reservedTime', [ncReservedTime, None], None, ),  # 5
)
all_structs.append(ncCanSyncJobRequest)
ncCanSyncJobRequest.thrift_spec = (
    None,  # 0
    ...
    (6, TType.STRING, 'senderJobId', 'UTF8', None, ),  # 6
)
all_structs.append(ncCanSyncJobResponseData)
ncCanSyncJobResponseData.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'originJob', [ncOriginJob, None], None, ),  # 1
    None,  # 2
    (3, TType.STRUCT, 'orginalInfo', [ncAuthUserInfo, None], None, ),  # 3
    (4, TType.LIST, 'senderInfo', (TType.STRUCT, [ncAuthUserInfo, None], False), None, ),  # 4
    (5, TType.LIST, 'recipientInfo', (TType.STRUCT, [ncAuthUserInfo, None], False), None, ),  # 5
)
all_structs.append(ncCanSyncJobResponse)
ncCanSyncJobResponse.thrift_spec = (
    None,  # 0
    (1, TType.I16, 'totalNum', None, None, ),  # 1
    (2, TType.LIST, 'datas', (TType.STRUCT, [ncCanSyncJobResponseData, None], False), None, ),  # 2
)
all_structs.append(ncCreateSyncTimePointRequest)
ncCreateSyncTimePointRequest.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'timePointInfos', (TType.STRUCT, [ncTimePointInfo, None], False), None, ),  # 1
)
all_structs.append(ncTimePointId)
ncTimePointId.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'id', 'UTF8', None, ),  # 1
)
all_structs.append(ncCreateSyncTimePointResponse)
ncCreateSyncTimePointResponse.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'TimePointIds', (TType.STRUCT, [ncTimePointId, None], False), None, ),  # 1
)
all_structs.append(ncUpdateSyncTimePointRequest)
ncUpdateSyncTimePointRequest.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'timePointIds', (TType.STRUCT, [ncTimePointId, None], False), None, ),  # 1
)
all_structs.append(ncSyncTimePointVolume)
ncSyncTimePointVolume.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'timePointId', 'UTF8', None, ),  # 1
    (2, TType.LIST, 'volumeInfos', (TType.STRUCT, [ncTimePointVolumeInfo, None], False), None, ),  # 2
)
all_structs.append(ncUpdateSyncTimePointVolumeRequest)
ncUpdateSyncTimePointVolumeRequest.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'syncTimePointVolumes', (TType.STRUCT, [ncSyncTimePointVolume, None], False), None, ),  # 1
)
all_structs.append(ncDeleteSyncTimePointRequest)
ncDeleteSyncTimePointRequest.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'timePointIds', (TType.STRUCT, [ncTimePointId, None], False), None, ),  # 1
)
all_structs.append(ncErrorInformation)
ncErrorInformation.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'jobId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'tpId', 'UTF8', None, ),  # 2
    (3, TType.I64, 'startTime', None, None, ),  # 3
    (4, TType.STRING, 'reason', 'UTF8', None, ),  # 4
)
all_structs.append(ncDeleteSyncTimePointResponse)
ncDeleteSyncTimePointResponse.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'ErrorInformations', (TType.STRUCT, [ncErrorInformation, None], False), None, ),  # 1
)
...
all_structs.append(ncUpdateJobStatusRequest)
ncUpdateJobStatusRequest.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'jobInfo', (TType.STRUCT, [ncJobInfo, None], False), None, ),  # 1
)
all_structs.append(ncJobCountInfo)
ncJobCountInfo.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'success', None, None, ),  # 1
    (2, TType.I32, 'failed', None, None, ),  # 2
    (3, TType.I32, 'running', None, None, ),  # 3
)
all_structs.append(ncTimePointsRequest)
ncTimePointsRequest.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'originJobId', 'UTF8', None, ),  # 1
    (2, TType.I16, 'index', None, 0, ),  # 2
    (3, TType.I16, 'count', None, 15, ),  # 3
)
all_structs.append(ncTimePointsResponse)
ncTimePointsResponse.thrift_spec = (
    None,  # 0
    (1, TType.I16, 'totalNum', None, None, ),  # 1
    (2, TType.LIST, 'datas', (TType.STRUCT, [ncTimePointInfo, None], False), None, ),  # 2
)
all_structs.append(ncBaseRequest)
ncBaseRequest.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'userId', 'UTF8', None, ),  # 1
    (2, TType.I16, 'index', None, 0, ),  # 2
    (3, TType.I16, 'count', None, 15, ),  # 3
)
all_structs.append(ncBackupJobsResponse)
ncBackupJobsResponse.thrift_spec = (
    None,  # 0
    (1, TType.I16, 'totalNum', None, None, ),  # 1
    (2, TType.LIST, 'datas', (TType.STRUCT, [ncJob.ttypes.ncTJob, None], False), None, ),  # 2
)
